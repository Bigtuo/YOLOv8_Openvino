...
class YOLOv6:
    """YOLOv6 object detection model class for handling inference and visualization."""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='yolov6s_1.0.onnx', help='Path to ONNX model')
    ...
    # Build model
    model = YOLOv6(args.model, args.imgsz, args.infer_tool)
